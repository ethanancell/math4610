/* Hybrid methods for returning the roots of functions a doubles.
 * In this file we implement methods for a hybrid functions of the bisection
 * method and secant and newton methods.
 */
